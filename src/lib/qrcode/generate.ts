...
interface Options {
	...
	join: boolean;
	typeNumber: number;
	base64Image?: string; // If left empty, no logo will be added. Otherwise, the logo will be centered on the QR code. Logo from logoPath converted to base64 by the svelte qr code component
